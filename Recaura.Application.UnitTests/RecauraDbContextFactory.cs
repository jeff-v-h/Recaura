...
{
    public static class RecauraDbContextFactory
    {
        public static RecauraDbContext Create()
        {
            var options = new DbContextOptionsBuilder<RecauraDbContext>()
                .UseInMemoryDatabase(Guid.NewGuid().ToString())
                .Options;

            var context = new RecauraDbContext(options);
        ...
        public static void SeedSampleData(RecauraDbContext context)
        {
            AddPatients(context);
        ...
        public static void Destroy(RecauraDbContext context)
        {
