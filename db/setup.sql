...
CREATE TABLE CaseFiles (
    ...
    CONSTRAINT FK_CaseFiles_Patients_PatientId FOREIGN KEY PatientId REFERENCES Patients(Id)
    ON DELETE CASCADE
);
GO
CREATE TABLE Consultations (
    ...
    CONSTRAINT FK_Consultations_CaseFiles_CaseFileId FOREIGN KEY CaseFileId REFERENCES CaseFiles(Id)
    ON DELETE CASCADE
    CONSTRAINT FK_Consultations_Practitioners_PractitionerId FOREIGN KEY PractitionerId REFERENCES Practitioners(Id)
    ON DELETE CASCADE
);
GO
CREATE TABLE ObjectiveAssessments (
    ...
    CONSTRAINT FK_ObjectiveAssessments_Consultations_ConsultationId FOREIGN KEY ConsultationId REFERENCES Consultations(Id)
    ON DELETE CASCADE
);
GO
CREATE TABLE SubjectiveAssessments (
    ...
    CONSTRAINT FK_SubjectiveAssessments_Consultations_ConsultationId FOREIGN KEY ConsultationId REFERENCES Consultations(Id)
    ON DELETE CASCADE
);
GO