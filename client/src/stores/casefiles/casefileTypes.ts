...
//#region actions
export interface CreateCasefileRequestAction { type: string }
export interface CreateCasefileSuccessAction {
    type: string
    payload: Casefile;
}
export interface CreateCasefileFailureAction { type: string }

export interface GetCasefileRequestAction { type: string }
...
export interface UpdateCasefileRequestAction { type: string }
export interface UpdateCasefileSuccessAction {
    type: string
    payload: Casefile;
}
export interface UpdateCasefileFailureAction { type: string }

export interface DeleteCasefileRequestAction { type: string }
export interface DeleteCasefileSuccessAction { type: string }
export interface DeleteCasefileFailureAction { type: string }
